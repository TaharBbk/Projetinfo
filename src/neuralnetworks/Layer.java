...
public class Layer {
	...
	public void backprop_init(double[] expectedResult, double learningFactor){
		...
		//On lance l'appel de la backprop sur la couche precedente en passant en argument le vecteur que l'on vient de calculer, ainsi que le facteur d'apprentisssage qui reste le m̻me
